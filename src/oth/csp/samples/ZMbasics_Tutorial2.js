/*** Zen Module: ZMbasics_Tutorial2 ***/

self._zenClassIdx['http://www.intersystems.com/zen/mojo/ZMTutorial2/Template'] = 'ZMbasics_Tutorial2_Template';
self.ZMbasics_Tutorial2_Template = function(index,id) {
	if (index>=0) {ZMbasics_Tutorial2_Template__init(this,index,id);}
}

self.ZMbasics_Tutorial2_Template__init = function(o,index,id) {
...
function ZMbasics_Tutorial2_Template_serialize(set,s)
{
...
function ZMbasics_Tutorial2_Template_getSettings(s)
{
	s['name'] = 'string';
	this.invokeSuper('getSettings',arguments);
}

self.ZMbasics_Tutorial2_Template_myGetMainViewLayout = function(key,criteria) {
var myLayoutGraph = {};
myLayoutGraph = {
children: [
...
self.ZMbasics_Tutorial2_Template_onGetContent = function(providerName,key,criteria) {
var content = null;
switch(providerName) {
case 'mainViewLayout':
...
self.ZMbasics_Tutorial2_Template_ReallyRefreshContents = function() {
	zenInstanceMethod(this,'ReallyRefreshContents','','',arguments);
}
self.ZMbasics_Tutorial2_Template__Loader = function() {
	zenLoadClass('_ZEN_Mojo_Component_contentTemplate');
	ZMbasics_Tutorial2_Template.prototype = zenCreate('_ZEN_Mojo_Component_contentTemplate',-1);
	var p = ZMbasics_Tutorial2_Template.prototype;
	if (null==p) {return;}
	p.constructor = ZMbasics_Tutorial2_Template;
	...
	p._serverClass = 'ZMbasics.Tutorial2.Template';
	p._type = 'Template';
	p.serialize = ZMbasics_Tutorial2_Template_serialize;
	p.getSettings = ZMbasics_Tutorial2_Template_getSettings;
	p.ReallyRefreshContents = ZMbasics_Tutorial2_Template_ReallyRefreshContents;
	p.myGetMainViewLayout = ZMbasics_Tutorial2_Template_myGetMainViewLayout;
	p.onGetContent = ZMbasics_Tutorial2_Template_onGetContent;
}
/* EOF */