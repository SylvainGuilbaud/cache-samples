/*** Zen Module: ZMdemo_jQM143 ***/

self._zenClassIdx['http://www.intersystems.com/zen/mojo/demo/jQM143/baseTemplate'] = 'ZMdemo_jQM143_baseTemplate';
self.ZMdemo_jQM143_baseTemplate = function(index,id) {
	if (index>=0) {ZMdemo_jQM143_baseTemplate__init(this,index,id);}
}

self.ZMdemo_jQM143_baseTemplate__init = function(o,index,id) {
...
function ZMdemo_jQM143_baseTemplate_serialize(set,s)
{
...
function ZMdemo_jQM143_baseTemplate_getSettings(s)
{
	s['name'] = 'string';
	this.invokeSuper('getSettings',arguments);
}

self.ZMdemo_jQM143_baseTemplate_animationDemo = function(startTime,step,initialWait) {
var stepsTaken = 0;
setTimeout(function() {
...
self.ZMdemo_jQM143_baseTemplate_buttonsDemo = function(startTime,step,initialWait) {
var stepsTaken = 0;
setTimeout(function() {
var mainView = zen('mainView');
...
self.ZMdemo_jQM143_baseTemplate_checkboxDemo = function(startTime,step,initialWait) {
var stepsTaken = 0;
setTimeout(function() {
var mainView = zen('mainView');
...
self.ZMdemo_jQM143_baseTemplate_collapsibleDemo = function(startTime,step,initialWait) {
var stepsTaken = 0;
setTimeout(function() {
var mainView = zen('mainView');
...
self.ZMdemo_jQM143_baseTemplate_collapsiblesetDemo = function(startTime,step,initialWait) {
var stepsTaken = 0;
setTimeout(function() {
var mainView = zen('mainView');
...
self.ZMdemo_jQM143_baseTemplate_footerDemo = function(startTime,step,initialWait) {
var stepsTaken = 0;
setTimeout(function() {
var mainView = zen('mainView');
...
self.ZMdemo_jQM143_baseTemplate_formDemo = function(startTime,step,initialWait) {
var stepsTaken = 0;
setTimeout(function() {
var mainView = zen('mainView');
...
self.ZMdemo_jQM143_baseTemplate_getData = function(key,criteria) {
var data = {};
switch (key) {
case 'home':
...
self.ZMdemo_jQM143_baseTemplate_getLayout = function(key,criteria) {
var content = null;
...
self.ZMdemo_jQM143_baseTemplate_listviewDemo = function(startTime,step,initialWait) {
var stepsTaken = 0;
setTimeout(function() {
var mainView = zen('mainView');
...
self.ZMdemo_jQM143_baseTemplate_navbarDemo = function(startTime,step,initialWait) {
var stepsTaken = 0;
setTimeout(function() {
var mainView = zen('mainView');
...
self.ZMdemo_jQM143_baseTemplate_onGetContent = function(which,key,criteria) {
switch (which)
{
case 'layout':
...
self.ZMdemo_jQM143_baseTemplate_onchange = function(key,value,final,docViewId) {
...
self.ZMdemo_jQM143_baseTemplate_onselect = function(key,value,docViewId) {
...
self.ZMdemo_jQM143_baseTemplate_panelsDemo = function(startTime,step,initialWait) {
var stepsTaken = 0;
setTimeout(function() {
var mainView = zen('mainView');
...
self.ZMdemo_jQM143_baseTemplate_radiobuttonsDemo = function(startTime,step,initialWait) {
var stepsTaken = 0;
setTimeout(function() {
var mainView = zen('mainView');
...
self.ZMdemo_jQM143_baseTemplate_themesDemo = function(startTime,step,initialWait) {
var stepsTaken = 0;
setTimeout(function() {
var mainView = zen('mainView');
...
self.ZMdemo_jQM143_baseTemplate_ReallyRefreshContents = function() {
	zenInstanceMethod(this,'ReallyRefreshContents','','',arguments);
}
self.ZMdemo_jQM143_baseTemplate__Loader = function() {
	zenLoadClass('_ZEN_Mojo_Component_contentTemplate');
	ZMdemo_jQM143_baseTemplate.prototype = zenCreate('_ZEN_Mojo_Component_contentTemplate',-1);
	var p = ZMdemo_jQM143_baseTemplate.prototype;
	if (null==p) {return;}
	p.constructor = ZMdemo_jQM143_baseTemplate;
	...
	p._serverClass = 'ZMdemo.jQM143.baseTemplate';
	p._type = 'baseTemplate';
	p.serialize = ZMdemo_jQM143_baseTemplate_serialize;
	p.getSettings = ZMdemo_jQM143_baseTemplate_getSettings;
	p.ReallyRefreshContents = ZMdemo_jQM143_baseTemplate_ReallyRefreshContents;
	p.animationDemo = ZMdemo_jQM143_baseTemplate_animationDemo;
	p.buttonsDemo = ZMdemo_jQM143_baseTemplate_buttonsDemo;
	p.checkboxDemo = ZMdemo_jQM143_baseTemplate_checkboxDemo;
	p.collapsibleDemo = ZMdemo_jQM143_baseTemplate_collapsibleDemo;
	p.collapsiblesetDemo = ZMdemo_jQM143_baseTemplate_collapsiblesetDemo;
	p.footerDemo = ZMdemo_jQM143_baseTemplate_footerDemo;
	p.formDemo = ZMdemo_jQM143_baseTemplate_formDemo;
	p.getData = ZMdemo_jQM143_baseTemplate_getData;
	p.getLayout = ZMdemo_jQM143_baseTemplate_getLayout;
	p.listviewDemo = ZMdemo_jQM143_baseTemplate_listviewDemo;
	p.navbarDemo = ZMdemo_jQM143_baseTemplate_navbarDemo;
	p.onGetContent = ZMdemo_jQM143_baseTemplate_onGetContent;
	p.onchange = ZMdemo_jQM143_baseTemplate_onchange;
	p.onselect = ZMdemo_jQM143_baseTemplate_onselect;
	p.panelsDemo = ZMdemo_jQM143_baseTemplate_panelsDemo;
	p.radiobuttonsDemo = ZMdemo_jQM143_baseTemplate_radiobuttonsDemo;
	p.themesDemo = ZMdemo_jQM143_baseTemplate_themesDemo;
}
/* EOF */